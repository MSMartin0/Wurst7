...
public final class MultiAuraHack extends Hack implements UpdateListener
{
	...
	private final CheckboxSetting filterZombieTraders = new CheckboxSetting("Filter zombie villagers",
					"Won't attack zombie villagers.", false);
	...
	public MultiAuraHack()
	{
		...
		addSetting(filterZombieTraders);
	}
	...
	public void onUpdate()
	{
		...
		if(filterZombieTraders.isChecked())
